...
parser.add_argument("--image_dir", type=str, default="./scratchpad/images")
parser.add_argument("--output_dir", type=str, default="./scratchpad/output")
...
parser.add_argument(
    "--tvm-graph",
    type=str,
    default="./scratchpad/build/deploy_graph_image_600_340.json",
)
parser.add_argument(
    "--tvm-lib", type=str, default="./scratchpad/build/deploy_lib_image_600_340.tar"
)
parser.add_argument(
    "--tvm-params",
    type=str,
    default="./scratchpad/build/deploy_params_image_600_340.params",
)
